...
export default class App extends React.Component {
  ...
  render(){
    const filteredDrones = this.state.books.filter(filterDrone => filterDrone.name.toLowerCase().includes(this.state.searchText))
  return (
    <Router>
      <div>
        <Navbar/>
