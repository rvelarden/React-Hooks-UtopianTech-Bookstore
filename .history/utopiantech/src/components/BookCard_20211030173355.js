...
const BookCard = (props)=>{
    ...
    const listItemsToBuy = () => props.items.map((book) => (
      <div key={book.id} className="card">
        ...
        <div>
        <button disable={props.items.disable} text={props.items.text} onClick={()=> updateLike(book)}> {book.liked ? "Liked!" : "Like"} </button>
