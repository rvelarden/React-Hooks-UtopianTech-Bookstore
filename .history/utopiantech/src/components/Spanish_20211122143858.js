    ...
    <input
      ...
      />
       <select onChange={(e)=> setDropDown(e.target.value)} className="font-text-text">
              <option className="font-text-text">Seleccionar Categoria</option>
              {items.map(book => <option value={dropDown}>{book.cate}</option>)}
      </select>
        <br></br>
        <br></br>
      ...
      <h1 className="center-text font-text-text">CARRITO DE COMPRAS</h1> 
