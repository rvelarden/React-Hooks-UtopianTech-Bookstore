...
const Book = (props) => {
    ...
    const updateLike = useCallback(
      ...
      return(
            <div >
            <div className="center-text font-text-text" key={props.book.id} className="card">
            <div className="font-text"><h2>{`${props.book.name}`}</h2></div>
            ...
            <div>
            <button disable={items.disable} text={items.text} onClick={()=> updateLike(props.book)}> {text ? "Liked!" : "Like"} </button>
