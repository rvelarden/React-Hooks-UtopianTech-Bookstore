  ...
  return (
    <div >
      ...
      <select onChange={(e)=> setDropDown(e.target.value)} className="font-text-text">
        ...
        <br></br>
        <br></br>
      <img style={{ width: "200px", height: "80px", objectFit: "cover" }} className="logo" src="https://upload.wikimedia.org/wikipedia/commons/6/64/Utopia-logo-1.png"></img> <h1>TECH<h2/>
